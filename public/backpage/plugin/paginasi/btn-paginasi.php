  ...
  <div align="left">
    <ul class="pagination">
      ...
      <?php
          ...
          ?>
            <li><a href="<?php echo $view; ?>?page=<?php echo $LinkPrev; ?>">Sebelumnya</a></li>
       <?php     
          }else{
        ?> 
          <li><a href="<?php echo $view; ?>?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Sebelumnya</a></li>
         <?php
           } 
        }
      ?>
      ...
      <?php
       ...
       if($kolomCari=="" && $kolomKataKunci==""){
          ?>
            <li><a href="<?php echo $view; ?>?page=<?php echo $linkNext; ?>">Selanjutnya</a></li>
       <?php     
          }else{
        ?> 
           <li><a href="<?php echo $view; ?>?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Selanjutnya</a></li>
      <?php
        }
      }
      ?>
