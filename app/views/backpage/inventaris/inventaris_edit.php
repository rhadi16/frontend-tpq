                            ...
                            <div class='row'>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Nama Inventaris
                                        <input type="text" class="form-control" name="nama_inventaris" placeholder="Nama Inventaris.." required value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_beli" placeholder="Tanggal Beli.." required value="">
                                    </div>
                                </div>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        Harga Inventaris
                                        <input type="text" class="form-control" name="harga_beli" placeholder="Harga Inventaris.." required value="">
                                    </div>
                                </div>
                            </div>
                        </div>
