            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="mbr-section-full col-md-12 col-lg-11">
                        <h3 class="mbr-section-title display-2" id="judul" style="padding-top: 120px;">TAMPIL DATA REFERENSI BULAN</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <a href="<?php BASEURL; ?>backpage_referensi_bulan" class="btn btn-md btn-primary">
                              Bulan
                            </a>
                        ...
                        <form action="function/ref_bulan_func.php?action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="mbr-section col-md-12 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important; padding-top: unset;">
                                                <h4 class="mbr-section-title display-3" id="judul2">Tambah Bulan</h4>
                                                    ...
                                                    <div class='row'>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                Bulan
                                                                <input type="text" class="form-control" name="bulan" placeholder="Bulan.." required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Aksi">
                                    <a href="referensi_bulan_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_bulan_func.php?action=delete&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
