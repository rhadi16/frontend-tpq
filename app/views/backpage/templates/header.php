...
<div class="pace-activity"></div></div>
    ...
    <style type="text/css">
        :root {
          --body-bg-color: #bcaaa4;
          --nmain-color: #fff;
          --nmain-bg-color: #4e342e;
                ...
                <div class="mbr-table">
                    <div class="mbr-table-cell">
                        <div class="navbar-brand">
                            ...
                            <a class="navbar-caption" href="#" style="font-size: 15px;font-weight: bold;">Digital TPQ</a>
                        </div>
                    </div>
                    <div class="mbr-table-cell">
                        ...
                        <?php 
                          }elseif($_SESSION['hakakses_D1g1t4LTPQ']=="OPERATOR"){
                        ?>
