            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="mbr-section-full col-md-12 col-lg-11">
                        <h3 class="mbr-section-title display-2" id="judul" style="padding-top: 120px; margin-bottom: 10px">TAMPIL DATA REFERENSI BACAAN SHOLAT</h3>
                        
                        <div class="row">

                          <div class="col-xs-12">
                            <a href="<?php BASEURL; ?>backpage_referensi_bacaan_sholat" class="btn btn-md btn-primary">
                              Bacaan Sholat
                            </a>
                        ...
                        <form action="function/ref_bacaan_sholat_func.php?action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="mbr-section col-md-12 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important; padding-top: unset;">
                                                <h4 class="mbr-section-title display-3" id="judul2">Tambah Materi Hafalan</h4>
                                                    ...
                                                    <div class='row'>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                Tambah Hafalan Bacaan Sholat
                                                                <input type="text" class="form-control" name="materi_hafalan_bacaan_shalat" placeholder="Hafalan Bacaan Sholat.." required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="mbr-section-nopadding">
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              <thead>
                                <tr>
                                  <th scope="col">No</th>
                                  <th scope="col">Materi Hafalan Bacaan Sholat</th>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan Bacaan Sholat"><?php echo $data['materi_hafalan_bacaan_shalat']; ?></td>
                                  
                                  <td data-label="Aksi">
                                    <a href="referensi_bacaan_sholat_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_bacaan_sholat_func.php?action=delete&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
