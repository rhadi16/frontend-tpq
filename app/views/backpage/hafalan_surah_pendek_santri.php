            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="mbr-section-full col-md-12 col-lg-11">
                        <h3 class="mbr-section-title display-2" id="judul" style="padding-top: 120px; margin-bottom: unset;">Hafalan SURAH PENDEK</h3>
                        
                        <form action="function/surah_pendek_func.php?action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="mbr-section col-md-12 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important; padding-top: unset;">
                                                ...
                                                <button class="btn btn-success" id="tambah-btn" type="button"><i class="fa fa-plus"></i> Tambah Hafalan Surah Pendek</button>
                                                    ...
                                                    <div class='row'>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="id_hafalan_surah_pendek">
                                                                  <option selected>Pilih Hafalan Surah Pendek..</option>
                                                                  <?php 
                                                                    $qry1 = "SELECT * FROM ref_hafalan_surah_pendek";

                                                                    $dt1 = mysqli_query($mysqli, $qry1);

                                                                    while($data1 = mysqli_fetch_array($dt1)){
                                                                   ?>
                                                                      <option value="<?php echo $data1['id']; ?>"><?php echo $data1['materi_hafalan_surah_pendek']; ?></option>
                                                                  <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                        ...
                        <div class="mbr-section-nopadding">
                            ...
                            <h5 style="font-weight: bold;">Hafalan Surah Pendek</h5>
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px; margin-top: 30px;">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan"><?php echo $data['materi_hafalan']; ?> <br> <?php echo $data['ket_1']; ?></td>
                                  <td data-label="Tanggal 1"><?php echo datetimeFormat::TanggalIndo($data['tgl_1']); ?></td>
                                  <td data-label="Paraf 2"><?php echo $data['nama_penyimak']; ?></td>

                                  <td data-label="Aksi">
                                    <a href="function/surah_pendek_func.php?action=delete&id=<?php echo $data['id']; ?>&nist=<?php echo $data['nist']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
...
<script type="text/javascript">
    ...
    $('#tambah-btn').on('click', function(e) {
       ...
       if( $('#tambah-btn').html() == '<i class="fa fa-plus"></i> Tambah Hafalan Surah Pendek' )
       {
          $('#tambah-view').show();
          $('#tambah-btn').html('<i class="fa fa-remove"></i> Batal Tambah Hafalan Surah Pendek');
          $('#tambah-btn').attr('class', 'btn btn-danger');
       }else{
          $('#tambah-view').hide();
          $('#tambah-btn').html('<i class="fa fa-plus"></i> Tambah Hafalan Surah Pendek');
