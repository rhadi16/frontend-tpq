...
<html lang="en">
  ...
  <body>
      ...
      <main class="app__layout-content">
        ...
        <div class="app__dialog app__dialog--hide">
          <div class="app__dialog-content">
            <?php 
              if($_GET['p']=="absen-masuk"){
                echo "<h1>Apakah Anda Yakin Melakukan ABSEN MASUK?</h1>";
              }elseif($_GET['p']=="absen-pulang"){
                echo "<h1>Apakah Anda Yakin Melakukan ABSEN PULANG?</h1>";
              }elseif($_GET['p']=="riwayat-bacaan"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi RIWAYAT BACAAN Santri ini?</h1>";
              }elseif($_GET['p']=="hafalan-bacaan-sholat"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi HAFALAN BACAAN SHOLAT Santri ini?</h1>";
              }elseif($_GET['p']=="hafalan-doa-harian"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi HAFALAN DOA HARIAN Santri ini?</h1>";
              }elseif($_GET['p']=="hafalan-surah-pendek"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi HAFALAN SURAH PENDEK Santri ini?</h1>";
              }elseif($_GET['p']=="pembayaran-iuran"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi PEMBAYARAN IURAN Santri ini?</h1>";
              }elseif($_GET['p']=="detail-santri"){
                echo "<h1>Apakah Anda Yakin Mau Mengisi DETAIL SANTRI ini?</h1>";
              }  
    ...
    <img src="logo/logo2.png" style="position: absolute;">
    ...
    <script src="<?php BASEURL; ?>backpage/lib/qrcode/bundle.js?v=2"></script>
  
        <audio id="beepAudio">
            <source src="<?php BASEURL; ?>backpage/assets/audio/beep.mp3" type="audio/mpeg">
  ...
  <script type="text/javascript">
    ...
    var namanis = result.split('||');
    var nis     = namanis[0]; 
    var nama    = namanis[1]; 

    var _url  = "api/absen.php?p="+result+"/";


    if(type == "absen-masuk" || type == "absen-pulang")
    {

      $.ajax({

        type: 'GET',
        url: _url+result+"&type="+type,
    ...
    }else if(type == "riwayat-bacaan"){

      window.location.href = "riwayat_bacaan.php?nist="+nis;

    }else if(type == "hafalan-bacaan-sholat"){

      window.location.href = "hafalan_bacaan_sholat_santri.php?nist="+nis;

    }else if(type == "hafalan-doa-harian"){

      window.location.href = "hafalan_doa_harian_santri.php?nist="+nis;

    }else if(type == "hafalan-surah-pendek"){

      window.location.href = "hafalan_surah_pendek_santri.php?nist="+nis;

    }else if(type == "pembayaran-iuran"){

      window.location.href = "pembayaran.php?nist="+nis;

    }else if(type == "detail-santri"){

      window.location.href = "santri_detail.php?nist="+nis;

    }else{

      window.location.href = "operator_view.php?p="+result;
