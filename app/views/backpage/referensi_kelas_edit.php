...
<form action="function/ref_kelas_func.php?action=update" id="form_proposal" enctype="multipart/form-data" method="post">
            ...
            <div class="container">                
                <div class="row">
                    ...
                    <div class="mbr-section col-md-12 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important; padding-top: unset;">
                        <h4 class="mbr-section-title display-3" id="judul">Edit Data Detail Kelas</h4>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Kelas
                                        <input type="number" class="form-control" name="kelas" placeholder="Kelas.." required value="<?php echo $d['kelas']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-xs-right">
                                    <a class="btn btn-lg btn-info-outline" href="<?php BASEURL; ?>backpage_referensi_kelas"><span class="fa fa-backward"></span> KEMBALI </a>
