                            ...
                            <div class='row'>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Nama Pemberi
                                        <input type="text" class="form-control" name="nama" placeholder="Nama Pemberi.." required value="<?php echo $d['nama']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Alamat Pemberi
                                        <input type="text" class="form-control" name="alamat" placeholder="Alamat Pemberi.." required value="<?php echo $d['alamat']; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Pekerjaan Pemberi
                                        <input type="text" class="form-control" name="pekerjaan" placeholder="Pekerjaan Pemberi.." required value="<?php echo $d['pekerjaan']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group" style="display: none;" id="jumlah_uang">
                                        Jumlah Uang
                                        <input type="number" class="form-control" placeholder="Jumlah Uang Pemberi" id="jumlah_uang_val" name="jumlah_uang" value="<?php echo $d['jumlah_uang']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group" style="display: none;" id="benda_pemberian">
                                        Benda Pemberian
                                        <input type="text" class="form-control" placeholder="Benda Pemberian" id="benda_pemberian_val" name="benda_pemberian" value="<?php echo $d['benda_pemberian']; ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class='row'>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_diterima_donasi" placeholder="Tanggal Terima Donasi.." required value="<?php echo $d['tgl_diterima_donasi']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
