...
<div class="card">
  ...
  <div class="card-body table-responsive">
    <table class="gigo-responsive">
      <tbody>
        ...
        <tr>
          <th scope="row">Hubungan Keluarga Siswa Dengan Ortu/Wali</th>
          <td></td>
        </tr>
        <tr>
  ...
  <div class="card-body text-xs-right">
    ...
    <a class="btn btn-lg btn-primary" href="<?= BASEURL; ?>backpage_santri/cetak" target="_blank"><span class="fa fa-save"></span> CETAK </a>
  </div>
</div>
