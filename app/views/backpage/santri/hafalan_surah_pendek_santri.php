                            ...
                            <table class="gigo-responsive" style="margin-right: 10px; margin-top: 30px;">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan"><br></td>
                                  <td data-label="Tanggal 1"></td>
                                  <td data-label="Paraf 2"></td>

                                  <td data-label="Aksi">
                                    <a href="function/surah_pendek_func.php" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              </tbody>
