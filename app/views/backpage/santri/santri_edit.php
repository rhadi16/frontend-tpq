            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="mbr-section col-md-12 col-lg-offset-4 col-lg-8 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important;">
                        ...
                        <input type="hidden" name="nist1" value="">
                            ...
                            <div class='row'>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Nist
                                        <input type="text" class="form-control" name="nist" placeholder="Nist.." required value="">
                                    </div>
                                </div>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Tanggal Lahir
                                        <input type="date" class="form-control" name="tgl_lahir" placeholder="Tanggal Lahir.." required value="">
                                    </div>
                                </div>
                        ...
                        <div class="mbr-section-text">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-xs-right">
                                    <a class="btn btn-lg btn-info-outline" href="<?= BASEURL; ?>backpage_santri"><span class="fa fa-backward"></span> KEMBALI </a>
