            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="mbr-section-full col-md-12 col-lg-11">
                        <h3 class="mbr-section-title display-2" id="judul" style="padding-top: 120px; margin-bottom: 10px;">TAMPIL DATA REFERENSI DOA HARIAN</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <a href="<?php BASEURL; ?>backpage_referensi_doa_harian" class="btn btn-md btn-primary">
                              Doa Harian
                            </a>
                        ...
                        <form action="function/ref_doa_harian_func.php?action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class='row'>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                Tambah Hafalan Doa Harian
                                                                <input type="text" class="form-control" name="materi_hafalan_doa_harian" placeholder="Hafalan Doa Harian.." required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="mbr-section-nopadding">
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              <thead>
                                <tr>
                                  <th scope="col">No</th>
                                  <th scope="col">Materi Hafalan Doa Harian</th>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan Doa Harian"><?php echo $data['materi_hafalan_doa_harian']; ?></td>
                                  
                                  <td data-label="Aksi">
                                    <a href="referensi_doa_harian_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_doa_harian_func.php?action=delete&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
