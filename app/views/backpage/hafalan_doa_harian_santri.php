                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="id_hafalan_doa_harian">
                                                                  ...
                                                                  <?php 
                                                                    $qry1 = "SELECT * FROM ref_hafalan_doa_harian";

                                                                    $dt1 = mysqli_query($mysqli, $qry1);

                                                                    while($data1 = mysqli_fetch_array($dt1)){
                                                                   ?>
                                                                      <option value="<?php echo $data1['id']; ?>"><?php echo $data1['materi_hafalan_doa_harian']; ?></option>
                                                                  <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px; margin-top: 30px">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Aksi">
                                    <a href="function/doa_harian_func.php?action=delete&id=<?php echo $data['id']; ?>&nist=<?php echo $data['nist']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
