                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan Surah Pendek"></td>
                                  
                                  <td data-label="Aksi">
                                    <a href="<?= BASEURL; ?>backpage_referensi_surah_pendek/edit" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_surah_pendek_func.php" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              </tbody>
