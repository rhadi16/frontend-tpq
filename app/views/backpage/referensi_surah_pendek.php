            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="mbr-section-full col-md-12 col-lg-11">
                        <h3 class="mbr-section-title display-2" id="judul" style="padding-top: 120px; margin-bottom: 10px;">TAMPIL DATA REFERENSI SURAH PENDEK</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <a href="<?php BASEURL; ?>backpage_referensi_surah_pendek" class="btn btn-md btn-primary">
                              Surah Pendek
                            </a>
                        ...
                        <form action="function/ref_surah_pendek_func.php?action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class='row'>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="materi_hafalan_surah_pendek" placeholder="Hafalan Surah Pendek.." required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="mbr-section-nopadding">
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              <thead>
                                <tr>
                                  <th scope="col">No</th>
                                  <th scope="col">Materi Hafalan Surah Pendek</th>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Materi Hafalan Surah Pendek"><?php echo $data['materi_hafalan_surah_pendek']; ?></td>
                                  
                                  <td data-label="Aksi">
                                    <a href="referensi_surah_pendek_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_surah_pendek_func.php?action=delete&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              <?php $no++; } ?>
