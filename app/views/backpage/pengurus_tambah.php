                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_devisi" id="id_devisi" required>
                                          ...
                                          <?php 
                                            $qry2 = "SELECT * FROM ref_devisi";

                                            $dt2 = mysqli_query($mysqli, $qry2);

                                            while($data2 = mysqli_fetch_array($dt2)){
                                           ?>
                                              <option value="<?php echo $data2['id']; ?>"><?php echo $data2['devisi']; ?></option>
                                          <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_jabatan" id="id_jabatan" required="">
                                          ...
                                          <?php 
                                            $qry2 = "SELECT * FROM ref_jabatan";

                                            $dt2 = mysqli_query($mysqli, $qry2);

                                            while($data2 = mysqli_fetch_array($dt2)){
                                           ?>
                                              <option value="<?php echo $data2['id']; ?>"><?php echo $data2['jabatan']; ?></option>
                                          <?php } ?>
                                        </select>
                                    </div>
                                </div>
