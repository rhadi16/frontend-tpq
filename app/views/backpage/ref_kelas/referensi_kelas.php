                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td data-label="Detail Kelas"></td>
                                  
                                  <td data-label="Aksi">
                                    <a href="<?= BASEURL; ?>backpage_referensi_kelas/edit" class="btn btn-info btn-xs">Edit</a>
                                    <a href="function/ref_kelas_func.php" class="btn btn-danger btn-xs confirmation">Hapus</a>
                                  </td>
                                </tr>
                              </tbody>
