                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        Kelas
                                        <input type="number" class="form-control" name="kelas" placeholder="Kelas.." required value="">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-xs-right">
                                    <a class="btn btn-lg btn-info-outline" href="<?= BASEURL; ?>backpage_referensi_kelas"><span class="fa fa-backward"></span> KEMBALI </a>
