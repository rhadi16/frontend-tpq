                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        Tahun
                                        <input type="number" class="form-control" name="tahun" placeholder="Tahun.." required value="<?php echo $d['tahun']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-xs-right">
                                    <a class="btn btn-lg btn-info-outline" href="<?php BASEURL; ?>backpage_referensi_tahun"><span class="fa fa-backward"></span> KEMBALI </a>
