                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="no_identitas" class="form-control">
                                                                    ...
                                                                    <?php 
                                                                    $qry1 = "SELECT * FROM tb_pengurus";

                                                                    $dt1 = mysqli_query($mysqli, $qry1);

                                                                    while($data1 = mysqli_fetch_array($dt1)){
                                                                   ?>
                                                                      <option value="<?php echo $data1['nipg'].'-'.$data1['nama']; ?>"><?php echo $data1['nipg'].' - '.$data1['nama']; ?></option>
                                                                  <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                            ...
                            <table class="gigo-responsive" style="margin-right: 10px;">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td data-label="Data Pengajar"><?php echo $data['nama'].'<br>'.$data['no_identitas']; ?></td>
